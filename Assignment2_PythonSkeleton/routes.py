...
def list_car():
    ...
    # Otherwise try to get from the database
        ...
        # Modified for blank input for 'Find' button
...
def update_car():
    ...
    if (request.method == 'GET'):
        ...
        # Changed the employee to username with upper characters
        firstname = request.args.get('employee').split(" ")[0]
        employee = request.args.get('employee')[len(firstname)+1:]
